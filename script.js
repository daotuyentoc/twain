 ...
 !function(n) {
    ...
    function V(t, a) {
        ...
        return n.each(Z.lunar, function(n, e) {
            return e.d == t && e.m == a ? (r = e.i + " (" + e.d + "/" + e.m + " ÂL)",
            !1) : void 0
        }),
        r
    }
    ...
    n.fn.amLich = function(a) {
        ...
        switch (r.on("click", "td.ngaythang, td.homnay, td.tet, td.leam, td.leduong", function(a) {
            ...
            case "month":
                ...
                break;
            case "calendar":
                r.find(".calendar .calendar-month").html("Tháng " + y + " Năm " + v),
